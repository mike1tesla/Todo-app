          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  IconButton(
                      // khi đóng add_dialog sẽ xóa text trong TextFormField và reset select task
                      onPressed: () {
                        Get.back();
                  ...
                  TextButton(
                      // loại bỏ hiểu ứng background khi ấn
                      style: ButtonStyle(
                          overlayColor:
                      ...
                      onPressed: () {
                        if(homeCtrl.formKey.currentState!.validate()){
                          if(homeCtrl.task.value == null){
                            ...
                            // nếu không bị trùng todo_task thực hiện add todo_task
              ...
              child: TextFormField(
                ...
                validator: (value) {
                  if (value == null || value.trim().isEmpty) {
                    return 'Please enter yours todo item';
                  }
                  return null;
                },
              ),
            ...
            // Hiển thị các task và chọn task
            ...homeCtrl.tasks
                .map((element) => Obx(
                      () => InkWell(
